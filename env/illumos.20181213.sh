...
#
# OpenIndiana now ships a GCC preprocessor as /usr/bin/cpp, which causes the
# Eversholt compiler to use it, instead of fall back to /usr/lib/cpp.  We
# should just be direct:
#
export _ESC_CPP='/usr/lib/cpp'
